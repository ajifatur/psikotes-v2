...
class QuestionController extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        $user_age = self::generate_age($user->attribute->birthdate);
        ...
        foreach($score as $key=>$score_by_part) {
            // If GE
            if($key == 4) {
                $array['RW'][$array_IST[$key-1]] = self::convert_GE($score_by_part);
     ...
     * @return int $y
     */
    public static function generate_age($date)
    {
     ...
     * @return int $y
     */
    public static function convert_GE($score)
    {
        $array = [
            0 => 0,
            1 => 1,
